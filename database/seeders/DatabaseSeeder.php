    ...
    public function run(): void
    {
        ...
        $regionProfiles = [
            [
                ...
                'health_score' => 92,
                'irrigation_count' => 3,
                'crop_weights' => ['Wheat' => 60, 'Rice' => 30, 'Cotton' => 10],
            ],
            [
                'key' => 'haryana',
                'name' => 'Haryana',
                ...
                'soil_type' => 'Alluvial',
                'climate' => 'Semi-Arid',
                'rainfall_range' => '300-500 mm',
                'season' => 'Rabi Season (Oct-March)',
                'health_score' => 88,
                'irrigation_count' => 3,
                'crop_weights' => ['Wheat' => 50, 'Rice' => 20, 'Mustard' => 30],
            ],
            [
                'key' => 'uttar pradesh',
                'name' => 'Uttar Pradesh',
                ...
                'health_score' => 85,
                'irrigation_count' => 2,
                'crop_weights' => ['Wheat' => 40, 'Sugarcane' => 40, 'Rice' => 20],
            ],
            [
                'key' => 'madhya pradesh',
                'name' => 'Madhya Pradesh',
                ...
                'soil_type' => 'Black',
                'climate' => 'Tropical',
                'rainfall_range' => '900-1200 mm',
                'season' => 'Kharif Season',
                'health_score' => 78,
                'irrigation_count' => 2,
                'crop_weights' => ['Soybean' => 50, 'Wheat' => 30, 'Pulses (Chickpea, Lentil)' => 20],
            ],
            [
                'key' => 'maharashtra',
                'name' => 'Maharashtra',
                ...
                'rainfall_range' => '400-2500 mm',
                'season' => 'Kharif Dominant',
                'health_score' => 75,
                'irrigation_count' => 1,
                'crop_weights' => ['Cotton' => 40, 'Sugarcane' => 30, 'Soybean' => 30],
            ],
            [
                'key' => 'karnataka',
                'name' => 'Karnataka',
                ...
                'rainfall_range' => '500-3000 mm',
                'season' => 'Year-round',
                'health_score' => 82,
                'irrigation_count' => 2,
                'crop_weights' => ['Coffee' => 40, 'Rice' => 30, 'Spices (Turmeric, Pepper)' => 30],
            ],
            [
                'key' => 'tamil nadu',
                'name' => 'Tamil Nadu',
                ...
                'health_score' => 86,
                'irrigation_count' => 2,
                'crop_weights' => ['Rice' => 50, 'Groundnut' => 30, 'Sugarcane' => 20],
            ],
            [
                'key' => 'gujarat',
                'name' => 'Gujarat',
                ...
                'climate' => 'Semi-Arid',
                'rainfall_range' => '300-800 mm',
                'season' => 'Kharif',
                'health_score' => 80,
                'irrigation_count' => 2,
                'crop_weights' => ['Cotton' => 50, 'Groundnut' => 40, 'Wheat' => 10],
            ],
            [
                'key' => 'west bengal',
                'name' => 'West Bengal',
                ...
                'health_score' => 75,
                'irrigation_count' => 2,
                'crop_weights' => ['Rice' => 60, 'Jute' => 30, 'Tea' => 10],
            ],
            [
                'key' => 'rajasthan',
                'name' => 'Rajasthan',
                ...
                'soil_type' => 'Sandy',
                'climate' => 'Arid',
                'rainfall_range' => '150-400 mm',
                'season' => 'Kharif & Rabi',
                'health_score' => 65,
                'irrigation_count' => 1,
                'crop_weights' => ['Bajra' => 50, 'Mustard' => 30, 'Wheat' => 20],
            ],
            [
                'key' => 'andhra pradesh',
                'name' => 'Andhra Pradesh',
                ...
                'climate' => 'Tropical',
                'rainfall_range' => '700-1000 mm',
                'season' => 'Kharif & Rabi',
                'health_score' => 82,
                'irrigation_count' => 2,
                'crop_weights' => ['Rice' => 50, 'Cotton' => 30, 'Spices (Turmeric, Pepper)' => 20],
            ],
            [
                'key' => 'bihar',
                'name' => 'Bihar',
                ...
                'soil_type' => 'Alluvial',
                'climate' => 'Humid Subtropical',
                'rainfall_range' => '1000-1200 mm',
                'season' => 'Kharif & Rabi',
                'health_score' => 70,
                'irrigation_count' => 2,
                'crop_weights' => ['Rice' => 50, 'Wheat' => 30, 'Vegetables (Mixed)' => 20],
            ],
            [
                'key' => 'assam',
                'name' => 'Assam',
                ...
                'climate' => 'Tropical Monsoon',
                'rainfall_range' => '2000-2800 mm',
                'season' => 'Year-round',
                'health_score' => 78,
                'irrigation_count' => 1,
                'crop_weights' => ['Tea' => 60, 'Rice' => 30, 'Jute' => 10],
            ],
            [
                'key' => 'kerala',
                'name' => 'Kerala',
                ...
                'soil_type' => 'Laterite',
                'climate' => 'Tropical Monsoon',
                'rainfall_range' => '2500-3000 mm',
                'season' => 'Year-round',
                'health_score' => 88,
                'irrigation_count' => 1,
                'crop_weights' => ['Coconut' => 50, 'Spices (Turmeric, Pepper)' => 30, 'Coffee' => 20],
            ],
            [
                'key' => 'odisha',
                'name' => 'Odisha',
                ...
                'soil_type' => 'Red & Laterite',
                'climate' => 'Tropical Monsoon',
                'rainfall_range' => '1400-1600 mm',
                'season' => 'Kharif',
                'health_score' => 74,
                'irrigation_count' => 1,
                'crop_weights' => ['Rice' => 70, 'Pulses (Chickpea, Lentil)' => 20, 'Jute' => 10],
            ],
        ];
